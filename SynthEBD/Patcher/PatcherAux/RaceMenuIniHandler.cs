...
public class RaceMenuIniHandler
{
    ...
    {
        success = false;
        string iniPath64 = Path.Combine(_patcherEnvironmentProvider.Environment.DataFolderPath, "SKSE", "Plugins", "skee64.ini");
        string iniPathVR = Path.Combine(_patcherEnvironmentProvider.Environment.DataFolderPath, "SKSE", "Plugins", "skeevr.ini");
    ...
    {
        string iniPath = Path.Combine(_patcherEnvironmentProvider.Environment.DataFolderPath, "SKSE", "Plugins", fileName);
        try
        {
