...
public class AssetAndBodyShapeSelector
{
    ...
    public AssetAndBodyShapeSelector(Logger logger, AssetSelector assetSelector, BodyGenSelector bodyGenSelector, OBodySelector oBodySelector)
    {
        _logger = logger;
