...
public class AssetSelector
{
    ...
    public AssetSelector(Logger logger, SynthEBDPaths paths, AssetAndBodyShapeSelector assetAndBodyShapeSelector, AttributeMatcher attributeMatcher, RecordPathParser recordPathParser, DictionaryMapper dictionaryMapper)
    {
        _logger = logger;
        _paths = paths;
    ...
    public HashSet<SubgroupCombination> SelectAssetReplacers(FlattenedAssetPack chosenAssetPack, NPCInfo npcInfo, AssetAndBodyShapeSelector.AssetAndBodyShapeAssignment currentAssignments)
    {
        ...
        foreach (var replacerGroup in chosenAssetPack.AssetReplacerGroups)
        {
            ...
            if (assignReplacer)
            {
                ...
                var assignedCombination = _assetAndBodyShapeSelector.GenerateCombinationWithBodyShape(new HashSet<FlattenedAssetPack>() { virtualFlattenedAssetPack }, null, null, null, npcInfo, true, AssetAndBodyShapeSelector.AssetPackAssignmentMode.ReplacerVirtual, currentAssignments);
