            ...
            switch (_patcherState.GeneralSettings.BodySelectionMode)
            {
                case BodyShapeSelectionMode.BodyGen:
                    if (currentAssignments != null && currentAssignments.AssignedBodyGenMorphs != null)
                    {
                        ...
                        {
                            if (subgroup.AllowedBodyGenDescriptors.Any() && !BodyShapeDescriptor.DescriptorsMatch(subgroup.AllowedBodyGenDescriptors, bodyGenTemplate.BodyShapeDescriptors, BodyShapeDescriptor.DescriptorMatchMode.All, out _))
                            {
                            ...
                            if (BodyShapeDescriptor.DescriptorsMatch(subgroup.DisallowedBodyGenDescriptors, bodyGenTemplate.BodyShapeDescriptors, BodyShapeDescriptor.DescriptorMatchMode.Any, out string matchedDescriptor))
                            {
                ...
                case BodyShapeSelectionMode.BodySlide:
                    ...
                    {
                        if (subgroup.AllowedBodySlideDescriptors.Any() && !BodyShapeDescriptor.DescriptorsMatch(subgroup.AllowedBodySlideDescriptors, currentAssignments.AssignedOBodyPreset.BodyShapeDescriptors, BodyShapeDescriptor.DescriptorMatchMode.All, out _))
                        {
                        ...
                        if (BodyShapeDescriptor.DescriptorsMatch(subgroup.DisallowedBodySlideDescriptors, currentAssignments.AssignedOBodyPreset.BodyShapeDescriptors, BodyShapeDescriptor.DescriptorMatchMode.Any, out string matchedDescriptor))
                        {
