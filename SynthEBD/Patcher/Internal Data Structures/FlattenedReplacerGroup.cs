...
public class FlattenedReplacerGroup
{
    ...
    public static FlattenedReplacerGroup FlattenReplacerGroup(AssetReplacerGroup source, List<RaceGrouping> raceGroupingList, FlattenedAssetPack parentAssetPack, DictionaryMapper dictionaryMapper)
    {
        ...
        for (int i = 0; i < source.Subgroups.Count; i++)
        {
            ...
            FlattenedSubgroup.FlattenSubgroups(source.Subgroups[i], null, flattenedSubgroups, raceGroupingList, parentAssetPack.GroupName, i, source.Subgroups, parentAssetPack, dictionaryMapper);
