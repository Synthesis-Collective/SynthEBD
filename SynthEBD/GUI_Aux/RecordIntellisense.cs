...
namespace SynthEBD
{
    ...
    public class RecordIntellisense
    {
        ...
        public static void RefreshPathSuggestions(IImplementsRecordIntellisense parent)
        {
            ...
            if (parent.LinkCache.TryResolve<INpcGetter>(parent.ReferenceNPCFormKey, out var referenceNPC) && RecordPathParser.GetObjectAtPath(referenceNPC, tmpPath, new Dictionary<dynamic, Dictionary<string, dynamic>>(), parent.LinkCache, true, out var subObj))
            {
