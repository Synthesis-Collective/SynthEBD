;These functions are used, with slight modifications, from clib: https://www.nexusmods.com/skyrimspecialedition/mods/58011
;Full credits to Cecell for making these functions.
;Permissions from clib page as of 2022 08 21: Use of any of this code is completely free and granted in perpetuity (as long as the mod itself doesn't run afoul of some law somewhere or cause harm to others or violate the TOS of the Nexus, etc, etc).  So, download it, open it up, look for what you want and just copy and paste! 
;Modifications from original:
;Changed "while remaining >= 0" to "while remaining >= 1" in cH2D function to remove Papyrus spam (function output was correct regardless)
;Removed all dependence on ConsoleUtil to avoid having an extra dependency

ScriptName SynthEBDcLib
